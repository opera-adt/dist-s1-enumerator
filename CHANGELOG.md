...
### Added
* Tests about MGRS tiles that are multipolygons are precisely those crossing anti-meridian.
* Updated readme with information about the tabular geometries and the dateline.
